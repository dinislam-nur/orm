package ru.iteco.first_adapter.utils;
...
public class UserUtils {
    ...
    public static User fromUserEntity(DbUserEntity userEntity, DbUserInfoEntity userInfoEntity) {
        return new User(userEntity.getId(), userEntity.getLogin(), userEntity.getPassword(),
                fromUserInfoEntity(userInfoEntity));
    }
